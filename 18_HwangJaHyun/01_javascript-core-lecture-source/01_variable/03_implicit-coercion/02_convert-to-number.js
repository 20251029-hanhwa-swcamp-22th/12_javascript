...
// 문자('a')는 숫자로 변환시 'NaN'이 되기 때문에
// NaN은 어떠한 비교 연산자를 이용해도 비교 불가
...
* */
console.log(+'', typeof + ''); // 빈칸을 숫자로 바꾸면 0이된다. // 0
console.log(+1);
console.log(+'javascript'); // NaN
console.log(+true); // 1
console.log(+false); // 0
console.log(+undefined); // NaN
/*console.log(+Symbol);*/ // 오류나요
// TypeError: Cannot convert a Symbol value to a number

console.log(+{}); // 객체, NaN
console.log(+[]); // 배열, 0(빈 배열) << 중요!!!
