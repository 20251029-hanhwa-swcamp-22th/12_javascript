...
const original2 = ['apple', 'banana', 'orange', 'grape', 'mango'];
...
// 배열 내 일부 요소가 콜백함수 테스트를 통과하는 지 확인하여
// true 또는 false 반환
...
// 배열 내 모든 요소가 콜백함수 테스트를 통과하는 지 확인하여
// true 또는 false 반환
...
console.log("점수가 80점 이상인 학생 모두 찾기 : ",
    students.filter(item => item.score >= 80));

// 점수가 80점 이상인 학생의 이름만 찾기(1개 find, n개 filter)
