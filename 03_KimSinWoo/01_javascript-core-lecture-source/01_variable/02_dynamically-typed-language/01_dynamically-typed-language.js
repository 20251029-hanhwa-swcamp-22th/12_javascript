...
/* null은 원래 별도 타입으로 구분되어야 하지만 JS 첫 번째
버전의 버그로 인해 null의 타입이 object로 구분되고 있음.
기존 코드에 영향을 미칠 수 있어서 버그이지만 아직 수정하지 않음. */

test = Symbol();
console.log(test, typeof test); // Symbol(), symbol
...
test = function(){}; // 함수
console.log(test, typeof test); // function = object의 한 종류
