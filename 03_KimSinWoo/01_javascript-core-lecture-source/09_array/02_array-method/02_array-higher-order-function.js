...
console.log("이름이 홍길동인 학생 인덱스 찾기 : ", students.findIndex(item => item.name === "홍길동"));
console.log("이름이 이순신인 학생 인덱스 찾기 : ", students.findIndex(item => item.name === "이순신"));
...
result = students
    ...
    .map(item => item.name);
console.log("80점 이상 학생 이름만: ", result);