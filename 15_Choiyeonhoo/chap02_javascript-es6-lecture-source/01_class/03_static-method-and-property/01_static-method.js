...
class Student {
    ...
    // 클래스 선언부 안에 위치하고 static키워드를 붙이면 정적 메서드가 선언된다.
...
// static method인 compare 메서드를 이용해서 정렬
...
Student.testMethod = () => {
  ...
  console.log("static method는 객체에 프로퍼티로 함수를 할당하는 것과 같다.")
};
...
// static 메서드는
// 객체 생성 없이도 class명.method명()으로 호출 가능
Student.testMethod();
