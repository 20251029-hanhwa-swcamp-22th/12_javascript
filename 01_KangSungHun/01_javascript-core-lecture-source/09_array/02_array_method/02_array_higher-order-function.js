...
// 그 결과가 참인 첫 번째 요소를 반환참인 요소가 존재하지 않는다면 undefined를 반환

// Array.prototype.findIndex  :
// 배열을 순회하며 각 요소에 대하여 인자로 주어진 콜백함수를 실행하여
// 그 결과가 참인 첫 번째 요소의 인덱스를 반환참인 요소가 존재하지 않는다면 -1을 반환
...
console.log("이름이 이순신인 학생 찾기 : ", students.find(item=> item.name === "이순신"));

console.log("이름이 홍길동인 학생 찾기 : ", students.findIndex(item=> item.name === "홍길동"));
console.log("이름이 이순신인 학생 찾기 : ", students.findIndex(item=> item.name === "이순신"));
...
console.log("80점 이상인 학생 이름 : ", result);