...
console.log("foodList.indexof('햄버거') : ", foodList.indexOf('햄버거') );
...
console.log("foodList.lastIndexOf('햄버거') : ", foodList.lastIndexOf('햄버거') );
...
// Array.prototype.shift() : 첫번째 요소를 꺼내서 제거
