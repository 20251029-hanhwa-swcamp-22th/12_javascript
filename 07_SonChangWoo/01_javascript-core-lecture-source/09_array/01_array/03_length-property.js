...
// -> 배열 길이를 초과한 요소들이 제거됨
// -> 배열 길이가 요소보다 많아지면 empty(빈 슬롯)으로 채움
arr.length = 3;
console.log("5. length를 3으로 설정 : ", arr); // [1,2,3]

arr.length = 10;
console.log("6. length를 10으로 설정 : ", arr); // [ 1, 2, 3, <7 empty items> ]

// JS는 배열의 요소가 연속적으로 위치하지 않고
// 일부가 비어있는 '희소 배열'을 허용한다.
const sparseArr = [,2, , 4];
console.log("7. 희소 배열 : ", sparseArr);
console.log("8. 희소 배열의 내부 구조 : ", Object.getOwnPropertyDescriptors(sparseArr));
